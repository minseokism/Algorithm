/*
	[10156 문제] 과자
	문제 - 동수는 제과점에 과자를 사러 가는데 현재 가진 돈이 모자랄 경우 부모님께 모자란 돈을 받으려고 한다. 
	...
	입력 - 첫 번째 줄에는 과자 한 개의 가격 K, 사려고 하는 과자의 개수 N, 현재 동수가 가진 돈 M이 각각 공백을 사이에 두고 주어진다. 
		  단, K, N은 1,000 이하의 양의 정수이고, M은 10만 이하의 양의 정수이다. (1 ≤ K, N ≤ 1,000, 1 ≤ M ≤ 100,000이다.) 
	출력 - 첫 줄에 동수가 부모님께 받아야 하는 돈의 액수를 출력한다. 
	예제 입력  - 300 4 1000
	예제 출력  - 200
*/
