/*
	[2605 문제] 줄 세우기
	문제 - 점심시간이 되면 반 학생 모두가 한 줄로 줄을 서서 급식을 탄다.
		  ...
		  그 방법은 다음과 같다. 학생들이 한 줄로 줄을 선 후, 첫 번째 학생부터 차례로 번호를 뽑는다.
		  ...
		  차례로 0, 1, 1, 3, 2번의 번호를 뽑았다고 하자, 첫 번째 학생부터 다섯 번째 학생까지
		  1부터 5로 표시하면 학생들이 줄을 선 순서는 다음과 같이 된다.
	...
	입력 - 첫째 줄에는 학생의 수가 주어지고 둘째 줄에는 줄을 선 차례대로 학생들이 뽑은 번호가 주어진다.
...
public class Num2605 {
	...
	public static void main(String[] args) {
		...
		System.out.println(ls.toString().replace("[","").replace(",","").replace("]",""));
